    ...
    >
      <div className="row g-0 min-vh-100">
        ...
        <motion.div
          ...
          className="col-12 col-md-5 d-flex align-items-center justify-content-center bg-white shadow-lg order-2 order-md-1"
        >
          <motion.div
            variants={containerVariants}
            initial="hidden"
            animate="visible"
            className="py-5 px-4 px-md-3"
          ...
          >
            ...
            <div className="row g-2 mb-3">
              <motion.div variants={itemVariants} className="col-12 col-sm-6">
        ...
        {/* RIGHT SIDE - NOW VISIBLE ON MOBILE ALSO */}
        <div
          className="col-12 col-md-7 d-flex position-relative align-items-center justify-content-center order-1 order-md-2"
          style={{
        ...
        >
          ...
          <div className="text-center z-1 px-3 py-4">
            {/* Bars */}
            <div
            ...
            <div className="text-white">
              ...
              >
                Trade like a pro with expert insights and lightning-fast
                execution.
              </p>
            </div>
          </div>
