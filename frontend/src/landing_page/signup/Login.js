  ...
  return (
    ...
    >
      <div className="row g-0 min-vh-100">
        ...
        <div
          className="col-12 col-md-7 d-flex position-relative align-items-center justify-content-center order-1 order-md-1"
          style={{
        ...
        >
          ...
          <div className="text-center text-white z-1 px-3 px-md-5 py-4">
            <motion.div
            ...
            >
              ...
              <p className="lead opacity-75 fs-6 fs-md-5">
            ...
            {/* Chart */}
            <div
              className="mt-4 mt-md-5 position-relative mx-auto"
              style={{
                height: "150px",
                width: "100%",
                maxWidth: "320px",
